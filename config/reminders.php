...
return [
    ...
    'template_confirmed' => "Hello {patient_name},\n\nThis is a friendly reminder of your appointment at our clinic today at {appointment_time}.\n\nWe look forward to seeing you!",

    // Message template for UNCONFIRMED (status 0) appointments.
    'template_unconfirmed' => "Hello {patient_name},\n\nYour appointment at our clinic is scheduled for today at {appointment_time}. Please reply or call us to confirm your attendance.\n\nThank you.",
];
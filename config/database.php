...
return [
    ...
    */
    ...
    'database' => env('DB_DATABASE', 'referral_system'),
    ...
    'options' => extension_loaded('pdo_mysql') ? array_filter([
       ...
       'mysql_referral_test' => [
    'driver' => 'mysql',
    'url' => env('DB_REFERRAL_TEST_URL'),
    'host' => env('DB_REFERRAL_TEST_HOST', '127.0.0.1'),
    'port' => env('DB_REFERRAL_TEST_PORT', '3306'),
    'database' => env('DB_REFERRAL_TEST_DATABASE', 'referral_test'),
    'username' => env('DB_REFERRAL_TEST_USERNAME', 'root'),
    'password' => env('DB_REFERRAL_TEST_PASSWORD', ''),
    'unix_socket' => env('DB_SOCKET', ''),
    'charset' => 'utf8mb4',
